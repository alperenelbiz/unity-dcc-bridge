...
```
https://github.com/alperenelbiz/unity-dcc-bridge.git?path=/Packages/com.alperenelbiz.dccbridge#v0.7.0
```

Pin the tag. Without `#v0.7.0` you track the default branch and every fetch may bring
breaking changes.
